...
class TestDouban(unittest.TestCase):
    ...
    def test_login(self):
        ...
        self.assert '小杨阳的帐号' == self.accountMsg
        logger.info('页面跳转成功')
    ...
    def test_searchMovie(self):
        ...
        self.assert '少年的你' == self.subjectTitleText
    ...
    def test_downloadAppPanelisDisable(self):
        lnkDownloadApp = WebDriverWait(self.driver, 20, 0.2).until(
        ...
        self.assert 'block'== doubanappCssValue
        logger.info('test ok')
